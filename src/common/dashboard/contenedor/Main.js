...
import HistorialPersona from '../../../pages/VistaRecurso/HistorialPersona'
...
const Main = () => {
    ...
    return (
        <div className="main__contenedor">
            ...
            <Route path="/principal/historial/:idrecurso/:idpersona" exact={true} component={HistorialPersona}/>
